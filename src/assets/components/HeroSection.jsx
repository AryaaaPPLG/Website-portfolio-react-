        ...
        <div className="container max-w-4xl mx-auto text-center z-10">
            <div className="space-y-6">
                <h1 className="text-4xl md:text-6xl font-bolt tracking-tight">
                    <span className="opacity-0 animate-fade-in text-5xl font-extrabold text-center text-foreground mb-4 tracking-tight">Hai, Saya </span>
                    <span className="text-5xl font-extrabold text-center text-foreground mb-4 tracking-tight text-primary opacity-0 animate-fade-in cursor-target">Arya </span>
                    <span className="text-gradient ml-2 opacity-0 animate-fade-in-delay-2 text-5xl font-extrabold text-center text-foreground mb-4 tracking-tight">Prana Jaya</span>
                </h1>
